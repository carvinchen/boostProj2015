    ...
    if(logpath != ""){ 
        ...
        if(typpos >= 0){ 
            ...
            if(logfile_str_type == "log"){ 
                ...
                std::cout << "the typ of a log file should be *.log \n"; 
            } 
        }else{ 
  
            //printf("the file name should be like path/to/file.log \n"); 
            std::cout << "the file name should be like path/to/file.log \n"; 
        ...
        std::cout << "the input for a log file should be like path/to/file.log \n"; 
    } 
